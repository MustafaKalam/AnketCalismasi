...
namespace proje1
{
    public partial class frmPersonel : Form
    {
        ...
        private void btnEkle_Click_1(object sender, EventArgs e)
        {
            ...
            {
                sqlConnection.Open();
                SqlCommand arama = new SqlCommand("select * from personel where tc=" + txtTC.Text + "", sqlConnection);
                SqlDataReader oku = arama.ExecuteReader();
                if (oku.Read())
                {
                    MessageBox.Show("Bu TC numarasına ait personel bulunmakta");
                }
                else
                {
                    oku.Close();
                    SqlCommand ekle = new SqlCommand("insert into personel(TC,Adi,Soyadi,PersonelKodu,Sifre,Bolge,Cinsiyet) values(@k1,@k2,@k3,@k4,@k5,@k6,@k7) ", sqlConnection);
                    ekle.Parameters.AddWithValue("@k1", txtTC.Text);
        ...
        private void btnSil_Click_1(object sender, EventArgs e)
        {
            ...
            if (txtTC.Text == "")
            {
                MessageBox.Show("Silmek istediğiniz personelin TC Numarasını Giriniz");
            }
            else
            {
                SqlCommand arama = new SqlCommand("select * from personel where tc=" + txtTC.Text + "", sqlConnection);
                ...
                {
                    oku.Close();
                    SqlCommand sil = new SqlCommand("delete from personel where tc=@k1", sqlConnection);
                ...
                {
                    MessageBox.Show("Bu TC numarasına ait personel bulunmamakta");
                }
        ...
        private void btnGuncelle_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    oku.Close();
                    SqlCommand ekle = new SqlCommand("update personel set Adi=@k2,Soyadi=@k3,PersonelKodu=@k4,Sifre=@k5,Bolge=@k6,Cinsiyet=@k7 where TC=@k1 ", sqlConnection);
                ...
                {
                    MessageBox.Show("Güncellemek istediğiniz personel bulunmamakta");
                }
        ...
        private void btnListele_Click_1(object sender, EventArgs e)
        {
            ...
            if (rndTc.Checked == true)
            {
                ...
                {
                    SqlDataAdapter da = new SqlDataAdapter("Select * from personel where TC=" + txtTC.Text + "", sqlConnection);
            ...
            else if (rndSifresi.Checked == true)
            {
                ...
                {
                    SqlDataAdapter da = new SqlDataAdapter("Select * from personel where Sifre='" + txtSifresi.Text + "'", sqlConnection);
                    DataSet ds = new DataSet();
                    da.Fill(ds);
                    dataGridView1.DataSource = ds.Tables[0];
                }
            ...
            else if (rndAd.Checked == true)
            {
                ...
                {
                    SqlDataAdapter da = new SqlDataAdapter("Select * from personel where Adi='" + txtAdi.Text + "'", sqlConnection);
                    DataSet ds = new DataSet();
                    da.Fill(ds);
                    dataGridView1.DataSource = ds.Tables[0];
                }
            ...
            else if (rndSoyad.Checked == true)
            {
                ...
                {
                    SqlDataAdapter da = new SqlDataAdapter("Select * from personel where Soyadi='" + txtSoyadi.Text + "'", sqlConnection);
                    DataSet ds = new DataSet();
                    da.Fill(ds);
                    dataGridView1.DataSource = ds.Tables[0];
                }
            ...
            else if (rndPersonelKodu.Checked == true)
            {
                ...
                {
                    SqlDataAdapter da = new SqlDataAdapter("Select * from personel where PersonelKodu='" + txtPersonelKodu.Text + "'", sqlConnection);
                    DataSet ds = new DataSet();
                    da.Fill(ds);
                    dataGridView1.DataSource = ds.Tables[0];
                }
            ...
            else if (rndBolgesi.Checked == true)
            {
                ...
                {
                    SqlDataAdapter da = new SqlDataAdapter("Select * from personel where Bolge='" + cmbBolgesi.Text + "'", sqlConnection);
                    DataSet ds = new DataSet();
                    da.Fill(ds);
                    dataGridView1.DataSource = ds.Tables[0];
                }
            ...
            else if (rndCinsiyet.Checked == true)
            {
                ...
                {
                    SqlDataAdapter da = new SqlDataAdapter("Select * from personel where Cinsiyet='Erkek'", sqlConnection);
                    DataSet ds = new DataSet();
                    da.Fill(ds);
                    dataGridView1.DataSource = ds.Tables[0];
                }
                ...
                {
                    SqlDataAdapter da = new SqlDataAdapter("Select * from personel where Cinsiyet='Kadın'", sqlConnection);
                    DataSet ds = new DataSet();
                    da.Fill(ds);
                    dataGridView1.DataSource = ds.Tables[0];
                }
        ...
        private void rndTc_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void rndAd_CheckedChanged_1(object sender, EventArgs e)
        {
            if ((sender as RadioButton).Checked)
            {
                txtAdi.Enabled = true;
        ...
        private void rndSoyad_CheckedChanged_1(object sender, EventArgs e)
        {
            if ((sender as RadioButton).Checked)
            {
                txtSoyadi.Enabled = true;
        ...
        private void rndPersonelKodu_CheckedChanged_1(object sender, EventArgs e)
        {
            if ((sender as RadioButton).Checked)
            {
                txtPersonelKodu.Enabled = true;
        ...
        private void rndSifresi_CheckedChanged_1(object sender, EventArgs e)
        {
            if ((sender as RadioButton).Checked)
            {
                txtSifresi.Enabled = true;
        ...
        private void rndBolgesi_CheckedChanged_1(object sender, EventArgs e)
        {
            if ((sender as RadioButton).Checked)
            {
                cmbBolgesi.Enabled = true;
        ...
        private void rndCinsiyet_CheckedChanged_1(object sender, EventArgs e)
        {
            if ((sender as RadioButton).Checked)
            {
                checkErkek.Enabled = true;
        ...
        private void checkErkek_CheckedChanged_1(object sender, EventArgs e)
        {
            checkKadin.Checked = false;
        }

        private void checkKadin_CheckedChanged(object sender, EventArgs e)
        {
            checkErkek.Checked = false;
        }
        ...
        private void hAKKIMIZDAToolStripMenuItem1_Click_1(object sender, EventArgs e)
        {
